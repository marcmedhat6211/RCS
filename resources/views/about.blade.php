                ...
                <!-- <div class="col-lg-7 col-xl-6"> -->
                    <!-- <div class="text-container"> -->
                        ...
                        <p>	Reliance Compliance Solutions Inc. (RCS) is a consulting company that was founded in 2020 and is 
                            ...
                            reporting entities such as Banks. Credit Unions, MSBs and Virtual currency dealers.<br><br>We specialize in Regulatory compliance, Anti Money Laundering and Counter Terrorist Financing 
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Act as Compliance Officer or Chief AML Officer  <span style="font-size: 12px"> **Terms & Conditions Apply**</span></div>
                            </li>
                        </ul>
                ...
                <div class="col-lg-12">
                    ...
                    <br>
                        <div class="image-wrapper">
                            <img style="border-radius: 50%;" class="img-fluid" src="images/Peter Morcos-removebg-preview.jpg" alt="alternative">
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img style="border-radius: 50%;" class="img-fluid" src="images/0-removebg-preview.jpg" alt="alternative">
                        </div> <!-- end of image wrapper -->
