...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <h4 style="color: white; font-size:1.5vw;"><span style="color: purple; font-size:2vw;">R</span>eliance <span style="color: purple; font-size:2vw;">C</span>ompliance <span style="color: purple; font-size:2vw;">S</span>olutions</h4>
        <!-- <h4 id="js-rotating">
