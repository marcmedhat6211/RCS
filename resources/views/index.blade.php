                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        <!-- <div class="text-container"> -->
                            ...
                            <a style="margin-top: 1px; position: absolute; top: 2; right: 0; font-size:1vw;" class="btn-solid-lg page-scroll" href="/contact">SCHEDULE A CONSULTATION TODAY</a>
                        <!-- </div> -->
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-lg page-scroll" style="font-size: 0.9vw;" href="/about#team">MEET THE TEAM</a>
